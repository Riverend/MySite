var bttnOptinFront = document.querySelector('.optinFront');
var bttnDropDown = document.querySelector('.dropDown');
...
var xcsds = document.querySelectorAll('.dropDown > a')
var blockHome = document.querySelector('.blockHome');
var sdsd = document.querySelectorAll('.blockHome > div');
